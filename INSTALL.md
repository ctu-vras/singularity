...
```sh
export VERSION=1.26.0 OS=linux ARCH=amd64  # change this as you need
...
compiling. E.g. to build the 4.4.0 release, checkout the
`v4.4.0` tag:

```sh
git checkout --recurse-submodules v4.4.0
```
